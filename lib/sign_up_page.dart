...
class _SignUpState extends State<SignUp> {
  ...
  void _saveUserData(String userId, String name, String email) async {
    // References for both databases
    final userRef = _database.ref().child('UserDatabase').child(userId).child('UserCredentials');
    final adminRef = _database.ref().child('AdminDatabase').child('UsersCredentials').child(userId);
